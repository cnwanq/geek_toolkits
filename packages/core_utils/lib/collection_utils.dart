...
/// 判断集合是否为空
bool isNullOrEmpty(Iterable? iterable) => iterable == null || iterable.isEmpty;

/// 判断 Map 是否为空
bool isMapNullOrEmpty(Map? map) => map == null || map.isEmpty;

/// 去重 List
List<T> unique<T>(List<T> list) => list.toSet().toList();
...
/// 扁平化二维 List
List<T> flatten<T>(List<List<T>> list) => list.expand((e) => e).toList();
...
/// 过滤掉 null 元素
List<T> filterNotNull<T>(Iterable<T?> items) =>
